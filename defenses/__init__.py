...
Слои:
- L1 (l1_sanitize): регексы + эвристики на тексте чанка.
- L2 (l2_embedding_anomaly): per-document z-score по cosine-расстоянию
  до центроида документа.
- L4 (l4_strict_verifier): расширение существующего verify_answer
  (детектит инъекции внутри cited chunks).
"""
from defenses import l1_sanitize, l2_embedding_anomaly, l4_strict_verifier

__all__ = ["l1_sanitize", "l2_embedding_anomaly", "l4_strict_verifier"]
